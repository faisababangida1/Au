...
// THE UPDATED BRAIN: Now includes strict capitalization rules
...
If the user asks to tap, click, or search after opening the app, include a "click_text" field.
CRITICAL RULE: The "click_text" MUST exactly match the capitalization of the physical button on the phone screen. For example, output "Compose" with a capital C, or "Search" with a capital S, even if the user types it in lowercase.
